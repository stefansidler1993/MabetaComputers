      ...
      <div class="container top-sect">
        <div class="navbar-header">
          <h1 class="navbar-brand">
            <a data-type='rd-navbar-brand'  href="./">Mabeta<small>Computer</small></a>
          </h1>
        ...
        <div class="help-box text-right">
          <p>Need help?</p>
          <a href="callto:#">(809) 556-2983</a>
          <small><span>Hours:</span>  8:00am-5:30pm </small>
        </div>
      </div>
              ...
              <ul class="nav navbar-nav sf-menu" data-type="navbar">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="#">Programas de Loterias</a>
                    </li>
                    <li>
                      <a href="#">Veriphones</a>                      
                    </li>
